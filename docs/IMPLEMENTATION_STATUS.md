...
| Provider | hồ sơ, venue, đơn vị đặt, service, tạo/sửa/phát hành/hủy slot, chống trùng giờ |
...
| Manager/Admin | dashboard, provider, user, service, slot và report moderation; Admin quản lý quyền Manager |
