...
- [ ] Cấu hình Google OAuth qua `Email__GoogleClientId`, `Email__GoogleClientSecret`, `Email__GoogleRefreshToken` và `Email__GoogleSenderEmail`, sau đó thử đăng ký một Gmail thật và mở link xác minh.
