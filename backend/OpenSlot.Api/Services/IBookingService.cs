...
public interface IBookingService
{
    ...
    Task<SlotHoldResponse> CreateHoldAsync(Guid dealSlotId, string customerUserId, CancellationToken cancellationToken = default);
    Task<BookingConfirmationResponse> ConfirmHoldAsync(Guid holdId, string customerUserId, CancellationToken cancellationToken = default);
    Task ReleaseHoldAsync(Guid holdId, string customerUserId, CancellationToken cancellationToken = default);
