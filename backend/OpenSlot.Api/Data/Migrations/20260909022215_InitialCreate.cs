        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StrikeWindowStartedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                    BookingSuspendedUntilUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IconName = table.Column<string>(type: "TEXT", maxLength: 60, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Venues_ProviderProfiles_ProviderProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BasePriceVnd = table.Column<long>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceOfferings_Venues_VenueId",
                        column: x => x.VenueId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    ServiceOfferingId = table.Column<Guid>(type: "TEXT", nullable: false),
                    StartAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
                    EndAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
                    BookingOpensAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
                    BookingClosesAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
                    OriginalPriceVnd = table.Column<long>(type: "INTEGER", nullable: false),
                    DealPriceVnd = table.Column<long>(type: "INTEGER", nullable: false),
                    Capacity = table.Column<int>(type: "INTEGER", nullable: false),
                    ConfirmedBookingCount = table.Column<int>(type: "INTEGER", nullable: false),
                    CheckInEarlyMinutes = table.Column<int>(type: "INTEGER", nullable: false),
                    CheckInLateMinutes = table.Column<int>(type: "INTEGER", nullable: false),
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DealSlots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DealSlots_ServiceOfferings_ServiceOfferingId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublicCode = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    CheckInPinHash = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bookings_DealSlots_DealSlotId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_CustomerUserId_Status_BookedAtUtc",
                table: "Bookings",
                columns: new[] { "CustomerUserId", "Status", "BookedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_Bookings_DealSlotId_CustomerUserId",
                table: "Bookings",
                columns: new[] { "DealSlotId", "CustomerUserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Bookings_PublicCode",
                table: "Bookings",
                column: "PublicCode",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DealSlots_ServiceOfferingId_StartAtUtc",
                table: "DealSlots",
                columns: new[] { "ServiceOfferingId", "StartAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_DealSlots_Status_StartAtUtc",
                table: "DealSlots",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceOfferings_VenueId_CategoryId_IsActive",
                table: "ServiceOfferings",
                columns: new[] { "VenueId", "CategoryId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_Venues_City_District",
                table: "Venues",
                columns: new[] { "City", "District" });

            migrationBuilder.CreateIndex(
                name: "IX_Venues_ProviderProfileId",
                table: "Venues",
